    ...
    switch (action) {
        ...
        if (postIds && Array.isArray(postIds)) {
          ...
          postIds.forEach((id) => {
            ...
            if (post) {
              ...
              updatedPosts.push(post.title)
              updatedCount++
            }
          })
          console.log(`Admin bulk pinned ${updatedCount} posts:`, updatedPosts)
          return NextResponse.json({
            success: true,
            message: `${updatedCount} posts pinned successfully`,
            updatedCount,
          })
        }
        break
      ...
      case "bulk_unpin":
        if (postIds && Array.isArray(postIds)) {
          ...
          console.log(`Admin bulk unpinned ${updatedCount} posts:`, updatedPosts)
          return NextResponse.json({
            success: true,
            message: `${updatedCount} posts unpinned successfully`,
            updatedCount,
          })
        }
        break
      ...
      case "bulk_lock":
        if (postIds && Array.isArray(postIds)) {
          ...
          console.log(`Admin bulk locked ${updatedCount} posts:`, updatedPosts)
          return NextResponse.json({
            success: true,
            message: `${updatedCount} posts locked successfully`,
            updatedCount,
          })
        }
        break
      ...
      case "bulk_unlock":
        if (postIds && Array.isArray(postIds)) {
          ...
          console.log(`Admin bulk unlocked ${updatedCount} posts:`, updatedPosts)
          return NextResponse.json({
            success: true,
            message: `${updatedCount} posts unlocked successfully`,
            updatedCount,
          })
        }
        break
      ...
      case "bulk_hide":
        if (postIds && Array.isArray(postIds)) {
          ...
          console.log(`Admin bulk hid ${updatedCount} posts:`, updatedPosts)
          return NextResponse.json({
            success: true,
            message: `${updatedCount} posts hidden successfully`,
            updatedCount,
          })
        }
        break
      ...
      case "bulk_show":
        if (postIds && Array.isArray(postIds)) {
          ...
          console.log(`Admin bulk showed ${updatedCount} posts:`, updatedPosts)
          return NextResponse.json({
            success: true,
            message: `${updatedCount} posts shown successfully`,
            updatedCount,
          })
        }
        break
      ...
      case "update_category":
        if (postIds && Array.isArray(postIds) && updates?.categoryId) {
          let updatedCount = 0
          const updatedPosts: string[] = []
          postIds.forEach((id) => {
            const post = mockPosts.find((p) => p.id === id)
            if (post) {
              post.categoryId = updates.categoryId
              post.updatedAt = new Date().toISOString()
              updatedPosts.push(post.title)
              updatedCount++
            }
          })
          console.log(`Admin moved ${updatedCount} posts to category ${updates.categoryId}:`, updatedPosts)
          return NextResponse.json({
            success: true,
            message: `${updatedCount} posts moved to new category successfully`,
            updatedCount,
          })
        }
        break
...
// Export the mock data for other files to use if needed
export { mockPosts }
